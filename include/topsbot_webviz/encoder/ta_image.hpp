...
#ifndef TOPSBOT_WEBVIZ__ENCODER_TA_IMAGE_HPP_
#define TOPSBOT_WEBVIZ__ENCODER_TA_IMAGE_HPP_
...
/// RAII wrapper for ta_image_t backed by dmabuf (same pattern as topsbot_cv / topsbot_yolo).
class TaImage
{
public:
  TaImage();
...
#endif  // TOPSBOT_WEBVIZ__ENCODER_TA_IMAGE_HPP_
